...
exports.UpdatePatientSchema = exports.addPatientSchema = void 0;
...
exports.UpdatePatientSchema = joi_1.default.object({
    ...
    name: joi_1.default.string().min(3).max(255).messages({
        "string.base": "Name must be a string.",
        "string.min": "Name must be at least 3 characters long.",
        "string.max": "Name must not exceed 255 characters.",
    }),
    ...
    birthdate: joi_1.default.date().less("now").messages({
        "date.base": "Birthdate must be a valid date.",
        "date.less": "Birthdate must be a date in the past.",
    }),
    gender: joi_1.default.string().valid("male", "female").messages({
        "string.base": "Gender must be a string.",
        "string.valid": "Gender must be either 'male' or 'female'.",
    }),
    medicalHistory: joi_1.default.string().max(1000).optional().messages({
