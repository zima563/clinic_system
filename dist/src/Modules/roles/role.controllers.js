...
let roleControllers = class roleControllers {
    async createRole(req, body, res) {
        return await RoleService.createRole(res, {
            createdBy: req.user?.id,
            ...body,
        });
    }
    async allRoles(query, res) {
        return await RoleService.listRole(res, query);
    }
    async assignRoleToUser(req, userId, body, res) {
        return await RoleService.assignRoleToUser(res, userId, body.roleId, req.user.id);
    }
    async getAllRoleUsers(id, res) {
