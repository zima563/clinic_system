...
let doctorControllers = class doctorControllers {
    addDoctor(req, body, res) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            return yield doctorServices.addDoctor(req, res, Object.assign(Object.assign({}, body), { createdBy: (_a = req.user) === null || _a === void 0 ? void 0 : _a.id }));
        });
    }
    updateDoctor(req, body, id, res) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield doctorServices.updateDoctor(id, req, res, body);
        });
    }
    listDoctors(query, res) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield doctorServices.getDoctors(res, query);
        });
    }
    showDoctorDetails(id, res) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield doctorServices.getDoctor(res, id);
        });
    }
    DeactiveDoctor(id, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield doctorServices.deactiveOrActive(res, id);
        });
    }
};
