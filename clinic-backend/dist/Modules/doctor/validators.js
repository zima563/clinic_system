...
const validateDoctor = (phone) => __awaiter(void 0, void 0, void 0, function* () {
    if (phone) {
        if (yield prismaClient_1.prisma.doctor.findFirst({ where: { phone } })) {
...
const validatePhone = (phone, id) => __awaiter(void 0, void 0, void 0, function* () {
    if (phone) {
        if (yield prismaClient_1.prisma.doctor.findFirst({
            where: { phone, NOT: { id } },
        })) {
            throw new ApiError_1.default("doctor with this phone already exists");
        }
